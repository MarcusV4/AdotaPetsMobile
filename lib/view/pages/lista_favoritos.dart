        ...
        RichText(
          text: const TextSpan(
            children: [
              ...
              TextSpan(
                text: 'Favoritos',
                style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFFE8622A)),
              ),
            ],
          ),
        ),
        const SizedBox(height: 6),
        const Text('Pets que você salvou', style: TextStyle(fontSize: 14, color: Color(0xFF888888))),
